...
namespace ZVS.Global.Extensions
{
    public static class CollectionExtensions
    {
        ...
        /// <returns>Если вхождения добавились, то <see langword="true"/>, иначе <see langword="false"/> (обычно это если или принимаемая, или передаваемая коллекция null)</returns>
        ...
        public static void DistinctByFrom<TSource, TKey>(this ICollection<TSource> source, Func<TSource, TKey> keySelector)
        {
